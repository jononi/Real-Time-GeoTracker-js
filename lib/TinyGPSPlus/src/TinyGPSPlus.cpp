...
- ported latest version with 2 gnss sentences support for Particle devices
to do: test on electroon + photon
add another gn sentence
change distance_between and course_to
*/
